 ...
 */
public class Memory {
    private List<AddressCode_3> codeBlock;
    ...
    public Memory() {
        codeBlock = new ArrayList<AddressCode_3>();
    ...
    public int saveMemory() {
        codeBlock.add(new AddressCode_3());
        return codeBlock.size() - 1;
    }

    public void add3AddressCode(Operation op, Address opr1, Address opr2, Address opr3) {
        codeBlock.add(new AddressCode_3(op,opr1,opr2,opr3));
    }

    public void add3AddressCode(int i, Operation op, Address opr1, Address opr2, Address opr3) {
        codeBlock.remove(i);
        codeBlock.add(i, new AddressCode_3(op, opr1, opr2,opr3));
    }
...
class AddressCode_3 {
    ...
    public AddressCode_3() {

    }

    public AddressCode_3(Operation op, Address opr1, Address opr2, Address opr3) {
        operation = op;
        Operand1 = opr1;
        Operand2 = opr2;
        Operand3 = opr3;
